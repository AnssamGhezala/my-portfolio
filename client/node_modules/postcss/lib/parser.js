...
var Parser = function () {
    function Parser(input) {
        ...
        this.root.source = { input: input, start: { line: 1, column: 1 } ***REMOVED***
    }
    ...
    ***REMOVED***
    ...
    Parser.prototype.decl = function decl(tokens) {
        ...
        if (last[4]) {
            node.source.end = { line: last[4], column: last[5] ***REMOVED***
        } else {
            node.source.end = { line: last[2], column: last[3] ***REMOVED***
        }
        ...
        node.source.start = { line: tokens[0][2], column: tokens[0][3] ***REMOVED***
    ...
    ***REMOVED***
    ...
    Parser.prototype.atrule = function atrule(token) {
        ...
        while (!this.tokenizer.endOfFile()) {
            ...
            if (token[0] === ';') {
                node.source.end = { line: token[2], column: token[3] ***REMOVED***
                this.semicolon = true;
                break;
            } else if (token[0] === '{') {
                open = true;
                ...
                if (params.length > 0) {
                    ...
                    if (prev) {
                        node.source.end = { line: prev[4], column: prev[5] ***REMOVED***
                    }
                }
                this.end(token);
                break;
    ...
    ***REMOVED***
    ...
    Parser.prototype.end = function end(token) {
        ...
        if (this.current.parent) {
            this.current.source.end = { line: token[2], column: token[3] ***REMOVED***
    ...
    ***REMOVED***
    ...
    Parser.prototype.init = function init(node, line, column) {
        ...
        node.source = { start: { line: line, column: column }, input: this.input ***REMOVED***
    ...
    ***REMOVED***
    ...
    Parser.prototype.raw = function raw(node, prop, tokens) {
        ...
        if (!clean) {
            ...
            node.raws[prop] = { value: value, raw: raw ***REMOVED***
        }
        node[prop] = value;
    ***REMOVED***
