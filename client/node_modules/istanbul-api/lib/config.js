...
function defaultConfig() {
    ...
    ***REMOVED***
    ...
    ret.reporting['report-config'] = {***REMOVED***
    return ret;
}
 ...
 */
InstrumentOptions.prototype.root = function () { return path.resolve(this.config.root); ***REMOVED***
/**
