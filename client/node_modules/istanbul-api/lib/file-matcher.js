...
function filesFor(options, callback) {
    ...
    opts = { cwd: root, nodir: true, ignore: excludes ***REMOVED***
    seq += 1;
    ...
    fileset(includes.join(' '), excludes.join(' '), opts, function (err, files) {
        ...
        var realPathCache = module.constructor._realpathCache || /* istanbul ignore next */ {***REMOVED***
...
function matcherFor(options, callback) {
    ...
    filesFor(options, function (err, files) {
        ...
        matchFn = function (file) { return fileMap[file]; ***REMOVED***
