...
type A = {***REMOVED*** function x<Y: A>(i: Y) { i ***REMOVED*** x()
// Additional rules: {"no-unused-vars":1}

function x<Y: A>(i: Y) { i ***REMOVED*** type A = {***REMOVED*** x()
// Additional rules: {"no-unused-vars":1}

type A = {***REMOVED*** function x<Y: A.B.C>(i: Y) { i ***REMOVED*** x()
// Additional rules: {"no-unused-vars":1}

function x<Y: A.B.C>(i: Y) { i ***REMOVED*** type A = {***REMOVED*** x()
// Additional rules: {"no-unused-vars":1}
```
