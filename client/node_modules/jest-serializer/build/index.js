...
function replacer(key, value) {
  ...
  if (Number.isNaN(value)) {
    return {[JS_TYPE]: 'n'***REMOVED***
  }

  switch (value) {
    case undefined:
      return {[JS_TYPE]: 'u'***REMOVED***

    case +Infinity:
      return {[JS_TYPE]: '+'***REMOVED***
  ...
  switch (value && value.constructor) {
    case Date:
      return {[JS_TYPE]: 'd', [JS_VALUE]: value.getTime()***REMOVED***

    case RegExp:
      return {[JS_TYPE]: 'r', [JS_VALUE]: value.source, [JS_VF]: value.flags***REMOVED***

    case Set:
      return {[JS_TYPE]: 's', [JS_VALUE]: Array.from(value)***REMOVED***

    case Map:
      return {[JS_TYPE]: 'm', [JS_VALUE]: Array.from(value)***REMOVED***

    case Buffer:
      return {[JS_TYPE]: 'b', [JS_VALUE]: value.toString('latin1')***REMOVED***
  }
