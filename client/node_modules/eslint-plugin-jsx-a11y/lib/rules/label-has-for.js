...
var getValidityStatus = function getValidityStatus(node, required, allowChildren) {
  if (Array.isArray(required.some)) {
    ...
    return { isValid: _isValid, message: _message ***REMOVED***
  }
  if (Array.isArray(required.every)) {
    ...
    return { isValid: _isValid2, message: _message2 ***REMOVED***
  }
  ...
  return { isValid: isValid, message: message ***REMOVED***
***REMOVED***
  ...
  create: function create(context) {
    return {
      JSXOpeningElement: function JSXOpeningElement(node) {
        ...
        var required = options.required || { every: ['nesting', 'id'] ***REMOVED***
