...
function processAnswers(answers) {
    let config = { rules: {}, env: {}, parserOptions: {} ***REMOVED***
    ...
    if (answers.jsx) {
        config.parserOptions = config.parserOptions || {***REMOVED***
        config.parserOptions.ecmaFeatures = config.parserOptions.ecmaFeatures || {***REMOVED***
