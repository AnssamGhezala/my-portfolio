...
null}});r.Interface={type:null,target:null,currentTarget:function(){return null},eventPhase:null,bubbles:null,cancelable:null,timeStamp:function(a){return a.timeStamp||Date.now()},defaultPrevented:null,isTrusted:null***REMOVED***r.extend=function(a){function b(){return c.apply(this,arguments)}var c=this,e=function(){***REMOVED***e.prototype=c.prototype;e=new e;t(e,b.prototype);b.prototype=e;b.prototype.constructor=b;b.Interface=t({},c.Interface,a);b.extend=c.extend;C(b);return b***REMOVED***C(r);k=!("undefined"===typeof window||
!window.document||!window.document.createElement);var q={animationend:w("Animation","AnimationEnd"),animationiteration:w("Animation","AnimationIteration"),animationstart:w("Animation","AnimationStart"),transitionend:w("Transition","TransitionEnd")},y={},D={***REMOVED***k&&(D=document.createElement("div").style,"AnimationEvent"in window||(delete q.animationend.animation,delete q.animationiteration.animation,delete q.animationstart.animation),"TransitionEvent"in window||delete q.transitionend.transition);k=x("animationend");
...
pageY:b}]}},Simulate:null,SimulateNative:{},act:function(a){null===z&&(z=document.createElement("div"));m.unstable_batchedUpdates(a);m.render(g.createElement("div",null),z);return{then:function(){}}}***REMOVED***(function(){f.Simulate={***REMOVED***var a=void 0;for(a in F)f.Simulate[a]=O(a)})();[["abort","abort"],[k,"animationEnd"],[X,"animationIteration"],[Y,"animationStart"],["blur","blur"],["canplaythrough","canPlayThrough"],["canplay","canPlay"],["cancel","cancel"],["change","change"],["click","click"],["close","close"],
