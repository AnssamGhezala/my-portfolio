...
function programVisitor(types) {
    ...
    var opts = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : { coverageVariable: '__coverage__', inputSourceMap: undefined ***REMOVED***
    ...
    return {
        ...
        exit: function exit(path) {
            ...
            if (shouldIgnoreFile(path.find(function (p) {
                ...
                return { fileCoverage: coverageData, sourceMappingURL: visitState.sourceMappingURL ***REMOVED***
            }
