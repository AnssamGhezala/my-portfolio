...
<span class="cstat-no" title="statement not covered" >      rewriteCookieDomainConfig = { '*': rewriteCookieDomainConfig ***REMOVED***</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (typeof rewriteCookiePathConfig === 'string') { //also test for ''</span>
<span class="cstat-no" title="statement not covered" >      rewriteCookiePathConfig = { '*': rewriteCookiePathConfig ***REMOVED***</span>
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      rawHeaderKeyMap = {***REMOVED***</span>
