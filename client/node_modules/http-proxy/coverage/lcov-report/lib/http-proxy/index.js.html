...
&nbsp;
<span class="cstat-no" title="statement not covered" >  options = options || {***REMOVED***</span>
...
ProxyServer.prototype.listen = <span class="fstat-no" title="function not covered" >fu</span>nction(port, hostname) {
  var self    = <span class="cstat-no" title="statement not covered" >this,</span>
      closure = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >fu</span>nction(req, res) { <span class="cstat-no" title="statement not covered" >self.web(req, res); </span>***REMOVED***</span>
&nbsp;
