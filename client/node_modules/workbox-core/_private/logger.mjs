...
const _print = function(keyName, logArgs, levelColor) {
  ...
  const logPrefix = [
    '%cworkbox',
    `background: ${levelColor***REMOVED*** color: white; padding: 2px 0.5em; ` +
      `border-radius: 0.5em;`,
  ];
...
export {getDefaultLogLevel***REMOVED***
export {setLoggerLevel***REMOVED***
export {getLoggerLevel***REMOVED***
export {defaultExport as logger***REMOVED***
